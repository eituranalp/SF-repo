...
print("Starting AI Sales Funnel Audio Client...")

def find_device_index(name):
    """Find audio device index by name for input capture.
    
    Args:
        name (str): Partial or full device name to search for
    ...
    print(f"Device '{name}' not found. Available input devices:")
    for i, d in enumerate(devices):
